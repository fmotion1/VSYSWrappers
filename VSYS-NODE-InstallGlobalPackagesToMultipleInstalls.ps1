...
$readSpectreMultiSelectionSplat = @{
    Title = "Select versions of NPM you wish to install to."
...
if($Multiple -eq $true){
    ...
    $InstructionSingle = "[grey66]The packages [WHITE]$PackageList[/] will be installed in the following node versions:`n[/]"
    foreach ($SelectedVersion in $SelectedVersionsAddon) {
